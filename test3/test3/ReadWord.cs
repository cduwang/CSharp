...
namespace test3
{
    class ReadWord
    {
        ...
        {
            string fileName = @"C:\Users\lenovo\Desktop\18wang\CSharp\test3\国考_原题.docx";
            //文件路径;
        ...
        {
            string fileName = @"C:\Users\lenovo\Desktop\18wang\CSharp\test3\国考_标准答案1.docx";
        ...
        {
            string fileName = @"C:\Users\lenovo\Desktop\18wang\CSharp\test3\国考_标准答案2.docx";
            using (WordprocessingDocument wordprocessingDocument =
            WordprocessingDocument.Open(fileName, false))
            {
                // Create a Body object.
        ...
        {
            string fileName = @"C:\Users\lenovo\Desktop\18wang\CSharp\test3\国考_标准答案3.docx";
            using (WordprocessingDocument wordprocessingDocument =
            WordprocessingDocument.Open(fileName, false))
            {
                // Create a Body object.
